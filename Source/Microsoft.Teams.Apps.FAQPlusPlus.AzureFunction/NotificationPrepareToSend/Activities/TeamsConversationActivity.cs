            ...
            try
            {
                ...
                switch (response.Result)
                {
                    ...
                    case Result.Throttled:
                        throw new Exception(this.localizer.GetString("FailedToCreateConversationThrottledFormt", response.ErrorMessage));
                    default:
                        throw new Exception(this.localizer.GetString("FailedToCreateConversationFormat", response.ErrorMessage));
                }
            }
