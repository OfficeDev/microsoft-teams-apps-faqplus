...
namespace Microsoft.Teams.Apps.FAQPlusPlus.Common.Models
{
    ...
    public class ShareFeedbackCardPayload : TeamsAdaptiveSubmitActionData
    {
        ...
        /// Response Card: Response generated by the bot to user question by calling Question Answering service.
        /// </summary>
        public string UserQuestion { get; set; }

        /// <summary>
        /// Gets or sets the answer for the expert- Answer sent to the SME team along with feedback
        /// provided by the user on response given by bot calling Question Answering service.
        /// </summary>
