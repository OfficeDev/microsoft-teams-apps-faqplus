...
namespace Microsoft.Teams.Apps.FAQPlusPlus.AzureFunctionCommon.Services.MicrosoftGraph
{
    ...
    public interface IAppManagerService
    {
        ...
        Task InstallAppForUserAsync(string appId, string userId);
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
        Task InstallAppForTeamAsync(string appId, string teamId);
        ...
        Task<bool> IsAppInstalledForUserAsync(string appId, string userId);
        ...
        /// <param name="teamId">Team Id.</param>
        /// <returns>Returns true if the app is installed, false otherwise.</returns>
        Task<bool> IsAppInstalledForTeamAsync(string appId, string teamId);
        ...
        Task<string> GetAppInstallationIdForUserAsync(string appId, string userId);
        ...
        /// <param name="teamId">Team Id.</param>
        /// <returns>Teams App Installation Id.</returns>
        Task<string> GetAppInstallationIdForTeamAsync(string appId, string teamId);
    }
}
